        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-7xl mx-auto md:gap-16 lg:gap-5 items-center">
          ...
          >
            ...
            <div className="pt-2 md:pt-4">
              <button className="text-sm md:text-base font-semibold inline-flex items-center justify-center gap-2 p-3 md:px-6 md:py-3 md:px-8 md:py-4 bg-gradient-to-r from-blue-600 to-primary text-white rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                무료로 PR 분석 시작하기
              </button>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="mt-4 md:mt-5 text-base md:text-lg max-w-120 text-gray-700 leading-relaxed">
              길고 복잡한 커밋 내역들, 일일이 블로그 글로 정리하기 막막하셨죠? 분석하고 싶은 PR
              주소만 입력하세요. AI가 코드의 변경점과 기술적 의도를 정확히 파악해 README와 기술
              블로그 초안을 즉시 완성해 줍니다.
            </p>
